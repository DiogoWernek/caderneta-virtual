    ...
    const load = async () => {
      ...
      try {
        ...
        setForm({
          ...
          valor_aluguel: r.valor_aluguel != null ? formatBRL(r.valor_aluguel) : '',
          salario: r.salario != null ? formatBRL(r.salario) : '',
          valor_previdencia: r.valor_previdencia != null ? formatBRL(r.valor_previdencia) : '',
          valor_piedade_mensal: r.valor_piedade_mensal != null ? formatBRL(r.valor_piedade_mensal) : '',
          numero_filhos_trabalham: r.numero_filhos_trabalham?.toString() ?? '',
          salario_filhos: r.salario_filhos != null ? formatBRL(r.salario_filhos) : '',
